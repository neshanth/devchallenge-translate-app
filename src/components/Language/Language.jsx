...
const Language = () => {
  ...
  return (
    <div className="language-translate">
      <section className="header-languages">
        <p>Detect Language</p>
        {buttons.map((button) => (
          <button className="btn" key={button.key}>
            {button.text}
          </button>
        ))}
      </section>
      <section className="section-textarea">
        <textarea className="language-textarea" maxLength={500}></textarea>
      </section>
      <section className="section-text-count">
        <p>0/500</p>
      </section>
      <section className="section-footer">
        <div className="language-translate-options">
